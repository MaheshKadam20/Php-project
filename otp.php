...
<div class="rutuja">
 ...
 <input type="text" name="User_Name" style="margin-left:20px " placeholder="User Name"> <br><br>
...
<div class="rutuja">
 ...
 <input type="text" name="Mobile Number" style="margin-left:10px " placeholder="Mobile Number"><br> -->
 <label >Enter Your OTP:</label>
 <input type="number" placeholder="Enter OTP">
 <button type= submit ><a href="OTP.php"> Resend OTP</a></button>
...
<input type="password" name="new" style="margin-left:10px " placeholder="New Password"><br><br>
...
<div class="rutuja">
 ...
 <input type="password" name="confirm" style="margin-right:14px " placeholder="Confirm Password"><br><br>
